...
├── .github/agents/geral-robusto/             # Pacote de instruções para IA
├── public/             # Assets estáticos
└── .env.example        # Template de variáveis de ambiente
```

Detalhamento completo: [`docs/arquitetura/visao-geral.md`](docs/arquitetura/visao-geral.md).
...
3. Siga o ciclo de tarefas em [`.github/agents/geral-robusto/processos/20-ciclo-tarefa.md`](../processos/20-ciclo-tarefa.md)
...
Padrão do pacote [`.github/agents/geral-robusto/`](../). Detalhes em [`docs/contexto-projeto-ai.md`](docs/contexto-projeto-ai.md).
...
Aceitamos contribuições. Leia [`CONTRIBUTING.md`](CONTRIBUTING.md) primeiro.
