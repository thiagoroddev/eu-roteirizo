...
**4. Como sei qual `Esforço-IA` colocar?** Veja [módulo 20, seção 3.4](../processos/20-ciclo-tarefa.md#34-esforço-para-ia). Critério rápido: P-IA = 1-2 arquivos; M-IA = 2-5; G-IA = 5-12; XG-IA = 12+ (quebrar).
