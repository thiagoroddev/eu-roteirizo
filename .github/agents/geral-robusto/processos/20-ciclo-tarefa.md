...
Antes de entrar no ciclo, lembre dos modos definidos no [núcleo](../01-nucleo.md#4-modos-de-cerimônia):
...
| **Modo**                               | Light / Standard / Strict (ver [seção 2](#2-modos-de-cerimônia-revisitados))                                                                                               |
| **Valor**                              | Crítico / Importante / Desejável                                                                                                                                                                                                           |
| **Urgência**                           | Imediata / Normal                                                                                                                                                                                                                          |
| **Esforço-H/IA**                       | Duas medidas separadas por `/`. Humano (H) e IA. Exemplo: `M/G` = médio para humano, grande para IA. Valores: P / M / G / XG. Detalhes na [seção 3.4](#34-esforço-para-ia) |
...
A IA **nunca** adiciona tarefa sem confirmação se ela tem origem em requisito novo (que não existia). Para requisitos novos, ver fluxo em [`21-revisao-codigo.md`](./21-revisao-codigo.md#3-tarefas-geradas-por-revisão).
