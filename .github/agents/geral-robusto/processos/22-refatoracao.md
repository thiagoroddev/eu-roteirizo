...
Já abordada no [módulo 10](../padroes/10-codigo-e-convencoes.md#8-regra-de-três-abstrações). Mas em refatoração, a regra opera ao contrário: você está **decidindo** se vale extrair.
