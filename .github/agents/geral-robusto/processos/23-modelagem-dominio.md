...
Os dois são "ricos" - o comportamento vive próximo dos dados. A diferença é estilo, não conceito. Veja a comparação detalhada em [6.5](#65-comparação-quando-usar-cada-estilo).
