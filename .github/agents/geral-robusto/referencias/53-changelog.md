...
**Origem:** solicitação do humano — tornar o pacote profissional e auto-carregável nas três ferramentas, sem referência manual a módulos. Registrado também em `docs/tarefas/concluidas/` (TASK-REF-010).
