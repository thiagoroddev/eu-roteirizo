...
export const UI_LABELS = {
  ...
  ROUTES_PAGE: {
    ...
    SAVED_ON_DEVICE: "Salvos neste dispositivo",
    SORT_LABEL: "Ordenar:",
    SORT_RECENT_USE: "Mais recentes (uso)",
    SORT_IMPORT_DATE: "Data de importação",
    PACKAGES_LABEL: (count: number) => (count === 1 ? "1 pacote" : `${count} pacotes`),
    STOPS_LABEL: (count: number) => (count === 1 ? "1 parada" : `${count} paradas`),
    FILE_KIND_XLSX: "Planilha Excel",
    FILE_KIND_CSV: "Arquivo CSV",
    FILE_KIND_JSON: "Roteiro Exportado",
    SEARCH_ROUTES_PLACEHOLDER: "Buscar por rota ou código AT",
