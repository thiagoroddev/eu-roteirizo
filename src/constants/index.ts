...
export const ICON_KEYS = {
  ...
  HOME_WITH_DELIVERY: "HOME_WITH_DELIVERY",
  HOME_WITH_DELIVERY_CORRECTED: "HOME_WITH_DELIVERY_CORRECTED",
  HOME_WITHOUT_DELIVERY: "HOME_WITHOUT_DELIVERY",
  HOME_WITHOUT_DELIVERY_CORRECTED: "HOME_WITHOUT_DELIVERY_CORRECTED",

  OFFICE_WITH_DELIVERY: "OFFICE_WITH_DELIVERY",
  OFFICE_WITH_DELIVERY_CORRECTED: "OFFICE_WITH_DELIVERY_CORRECTED",
  OFFICE_WITHOUT_DELIVERY: "OFFICE_WITHOUT_DELIVERY",
  OFFICE_WITHOUT_DELIVERY_CORRECTED: "OFFICE_WITHOUT_DELIVERY_CORRECTED",

  INDEFINITE_WITH_DELIVERY: "INDEFINITE_WITH_DELIVERY",
  INDEFINITE_WITHOUT_DELIVERY: "INDEFINITE_WITHOUT_DELIVERY",
} as const;

// ========================================
// DELIVERY KEYS (internal representation)
// ========================================

/**
 * Internal keys used to represent Correios delivery status in the codebase.
 * Values are English identifiers; UI uses `UI_LABELS` for Portuguese presentation.
 */
