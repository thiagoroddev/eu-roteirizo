...
| [`arquitetura/ADR/`](./arquitetura/ADR/) | Decisões arquiteturais registradas (001 a 010) |
...
> O `tsconfig.json` da raiz é *solution-style* (`"files": []` e só `references`), e o `tsc` não
