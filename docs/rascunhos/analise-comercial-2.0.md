...
Os concorrentes diretos cobram **dezenas de dólares por mês** (faixa de R$50 a 250 dependendo do câmbio):

| App | Plano individual (mês) | Limite de paradas |
|---|---|---|
| Circuit / Spoke | US$ 10 (Lite) - US$ 20 (Standard) | ~500 |
| RoadWarrior | US$ 49 (Pro) | 200/rota |
| (free tiers) | US$ 0 | 8 a 10 paradas (inútil na prática) |
...
1. **Assinatura pela Play Store/App Store:** a loja cuida de cobrança e identidade; o app em si segue "sem login próprio". Custo: a loja fica com 15 a 30%. Mais simples e confiável; é o caminho natural para R$5/mês.
...
| Prova que gera | n/a | Tração que vira argumento p/ A |
...
2. **Preço se descobre testando.** Comece, meça conversão e churn, ajuste. R$5 pode estar **barato demais** (deixando dinheiro na mesa): o mercado cobra 10 a 50x isso. Vale testar R$5 vs R$10 vs R$15 e ver onde a conversão ainda segura. Ser o mais barato é vantagem; ser barato **demais** pode sinalizar "produto fraco" e ainda matar sua margem.
...
- Cobrança: **loja de apps** (corte de 15 a 30%, simples) vs **Pix + chave** (mais margem, mais trabalho/pirataria)?
...
| Esforço | Dias | Dias a semanas | Semanas a meses |
...
|---|---|---|
| Banner | ~US$ 0,20 a 0,50 | Evitar (rende quase nada) |
| Intersticial | ~US$ 2,15 | Evitar (intrusivo em ferramenta de trabalho) |
| **Rewarded** | ~US$ 1,92 | **Escolhido** (opt-in, na importação) |

**Receita estimada (especulação grossa):** ARPU de anúncio ~**R$ 1,50 a 3,00/mês por ativo** (depende de quantas importações/mês e do fill rate). Só vira material em escala:

| Ativos | Anúncio (~R$2/ativo) | Faixa plausível |
|---|---|---|
| 5.000 | ~R$ 10 mil/mês | R$ 5 a 22 mil |
| 10.000 | ~R$ 20 mil/mês | R$ 10 a 45 mil |
| 80.000 | ~R$ 160 mil/mês | R$ 80 a 360 mil |
