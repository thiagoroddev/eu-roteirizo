...
| RNF-18 | Vocabulário único em `UI_LABELS` (i18n): Parada · Endereço · Pacote · **Âncora** (curto) / **Parada do veículo (âncora)** (completo) · **Romaneio (Único/Multi)** · **Roteiro** | i18n | nenhum termo de domínio hardcoded | 🔭 | fluxo §2/§15 | TASK-RF-006 |
