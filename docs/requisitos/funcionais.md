...
| RF-23 | Criar parada a partir de um endereço, **sugerindo** os que estão dentro do raio (o usuário escolhe quais entram — toque no mapa ou painel; círculo tracejado; raio ajustável 10–200m) | MUST | ✅ | fluxo §4/§8 | TASK-RF-006.4 ✅ |
