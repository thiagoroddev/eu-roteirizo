...
|---|---|---|---|---|---|---|
| 01/09/26 21:31 | `TASK-RF-012` | RF | Auto-roteirizar por agrupamento de proximidade | - | absorvida por TASK-RF-029 | nao_requer |
| 05/09/26 18:34 | [`TASK-SPIKE-001`](./2026-09-05--18h34--TASK-SPIKE-001.md) | SPIKE | Definir e medir conversao, e a busca que a minimiza | - | concluida | dispensado |
...
| 15/09/26 06:48 | `TASK-CHORE-018` | CHORE | Atualizar esbuild para 0.28.1 ou superior (alerta Dependabot 1: leitura de arquivos pelo servidor de desenvolvimento no Windows) | - | cancelada: Duplicada da TASK-CHORE-023 (mesmo alerta Dependabot 1, esbuild GHSA-g7r4-m6w7-qqqr). Decisao do humano, 15/09/26: cancelar a mais antiga | nao_requer |
| 15/09/26 19:01 | [`TASK-CHORE-027`](./2026-09-15--19h01--TASK-CHORE-027.md) | CHORE | Corrigir pronto-para-merge que confunde IDs citados em PRs de planejamento com tarefas entregues e bloqueia a triagem de auditoria | - | concluida | dispensado |
| 16/09/26 22:45 | [`TASK-BG-024`](./2026-09-16--22h45--TASK-BG-024.md) | BG | Agrupar automaticamente enderecos no raio ao editar parada e salvar | - | concluida | aprovado |
